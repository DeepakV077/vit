...
const Dialog = React.forwardRef<any, React.ComponentProps<typeof DialogPrimitive.Root>>(function Dialog(
  props,
  ref,
) {
...
const DialogTitle = React.forwardRef<any, React.ComponentProps<typeof DialogPrimitive.Title>>(function DialogTitle(
  { className, ...props },
  ref,
) {
  return (
...
const DialogDescription = React.forwardRef<any, React.ComponentProps<typeof DialogPrimitive.Description>>(
